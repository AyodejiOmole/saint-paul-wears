...
//                 <Link
//                   href="/"
//                   className="block text-2xl font-medium text-foreground hover:text-accent transition-colors py-2 border-b border-transparent hover:border-accent"
//                   onClick={() => setIsMenuOpen(false)}
//                 >
//                   HOME
//                 </Link>
...
//                   <button
//                     onClick={() => setIsMobileShopOpen(!isMobileShopOpen)}
//                     className="flex items-center justify-between w-full text-2xl font-medium text-foreground hover:text-accent transition-colors py-2 border-b border-transparent hover:border-accent"
//                   >
//                     SHOP
